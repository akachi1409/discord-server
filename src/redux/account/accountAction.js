...
export const addWhitelist = (props) =>{
  return async (dispatch) => {
    ...
    try{
      axios.post("http://54.205.103.241:3000/member/addwhitelist", {
...
export const addRole = () =>{
  return async(dispatch) =>{
    ...
    try{
      axios.post("http://54.205.103.241:3000/member/add_role",{
        user: username
      })
      .then((res)=>{
        console.log(res)
        ...
        .then((response) => {
          axios
            ...
            .then((userResponse) => {
              ...
              axios
                .post("http://54.205.103.241:3000/member/find_member", {
                  user: username,
                })
                .then((res) => {
                  console.log("res", res);
