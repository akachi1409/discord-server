            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
              ...
              <div className="mt-10 text-gray-500 dark:text-white">
                {!localStorage.getItem("isMember")  ? (
                  ...
                  <div className="mx-auto py-5">
                    You don't have other projects to join.
                  </div>
                )}
                {!isMember  && (
                  <ul
                      ...
                      <div className="flex-1 flex flex-col p-8">
                        ...
                        <dl className="mt-1 flex-grow flex flex-col justify-between">
                          <dd className="text-sm">
                            ...
                            projects and DAOs. We're a team of 3 crypto
                            engineers with a proven track-record in the space.
                            We are not collecting wallets for Blocksmith Labs
                            yet!
                          </dd>
                          <dd className="mt-3">
